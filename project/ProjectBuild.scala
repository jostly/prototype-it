...
object ProjectBuild extends Build {
	lazy val root = Project(id = "prototype-it", base = file(".")) aggregate(playContext)

	lazy val common = Project(id = "common-lib", base = file("common-lib"))


	
	lazy val acceptance = Project(id = "acceptance", base = file("acceptance"))
		...
		lazy val application = Project(id = "application", base = file("play-context/application")) aggregate(command, query, sagas)

	lazy val playContext = 		Project(id = "play-context", base = file("play-context")) dependsOn(application)
